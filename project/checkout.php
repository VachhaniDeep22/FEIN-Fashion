                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
														<form id="login-form" method="post">
                                                            ...
                                                            <div class="dark-btn">
															<button type="button" class="fv-btn" onclick="usercLogin()">Login</button>
                                                            </div>
                                                        </form>
														<div class="form-output login_msg">
															<p class="form-messege field_error"></p>
														</div>
														<span>If You Don't Have Account Then<a href="login.php">CLICK HERE</a> To Register</span>
                                                    </div>
                                                </div>
										...
										<div class="accordion__body">
											<div class="bilinfo">
													...
													<div class="row">
														...
														<div class="col-md-6">
															<div class="single-input">
																<input type="text" name="pincode" placeholder="Post code" required >
															</div>
														</div>
                            ...
                            ?>
                                <div class="single-item">
                                    ...
                                    <div class="single-item__content">
                                        <a href=" categories.php?id=<?php $id?>"><?php echo $pname?></a>
