						...
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6" style="margin-left:100px;">Forgot Password</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn buttons-cart">
										<a href="<?php echo SITE_PATH ?>">Continue Shopping</a>
										<button type="button" class="st-btn" onclick="forgot_password()" id="btn_submit">Submit</button>                                       
									</div>
								</form>
