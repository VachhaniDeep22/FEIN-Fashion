...
$cat_res = mysqli_query($con,"select * from categories where status=1 order by categories .id asc");
$cat_arr=array();
                        ...
                        <div class="menumenu__container clearfix">
                            ...
                            <div class="col-md-3 col-lg-4 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="htc__shopping__cart" cellspacing="10">
                                        <?php
										if(isset($_SESSION['USER_ID'])){
										?>
										<a href="wishlist.php" class="mr15"><i class="icon-heart icons"></i>
                                        <a href="wishlist.php"><span class="htc__wishlist" id="cot"><?php echo $wishlist_count?></span></a></a>
										<?php } ?>
                                        <a  href="cart.php"><i class="icon-handbag icons"></i>
                                        <a href="cart.php"><span class="htc__qua"><?php echo $totalProduct?></span></a></a>
                                    </div>
                                </div>
                            </div>
                        </div>
