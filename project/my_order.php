                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name"><a href="#"></a><?php echo $row['added_on']?></td>
                                                ...
                                                <td class="product-name"><a href="#"></a><?php echo ucfirst($row['payment_status'])?></td>
                                                <td class="product-name"></a><?php echo ucfirst($row['order_status_str'])?></td>                                                
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
