						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								...
								<div class="contact-title">
									<h2 class="title__line--6" style="right: 200px;">Registration Form</h2>
								</div>
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="email" name="email" id="email" placeholder="Your Email*" style="width:30%">

											<button type="button" class="fv-btn email_sent_otp height_60px" onclick="emailSentOtp()">Send OTP</button>
											
											<input type="text" id="email_otp" placeholder="OTP" style="width: 30%;" class="email_verify_otp">
											
											
											<button type="button" class="fv-btn email_verify_otp height_60px" onclick="emailVerifyOtp()">Verify OTP</button>
											
											<span id="email_otp_result"></span>
										</div>
										<p style="color:green;">Please Verify Your Email Before Ragister</p>
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="userRegister()" disabled id="btn_register">Register</button>
									</div>
								</form>
